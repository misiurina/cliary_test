  ...
  void initState() {
    ...
    if (widget.scrollController != null) {
      ...
      _scrollController.animateTo(
        widget.initialOffset * _hourHeight - 0.5 * _hourHeight,
    ...
    _scrollController = ScrollController(
      initialScrollOffset: widget.initialOffset * _hourHeight - 0.5 * _hourHeight,
    );
  }
    ...
    return SingleChildScrollView(
      ...
      child: SizedBox(
        ...
        child: PageView.builder(
          ...
          itemBuilder: (_, index) {
            final date =
                DateTime(_minDate.year, _minDate.month, _minDate.day + index);
